...
public abstract class AbstractLauncherUiTest {
    ...
    protected UiObject2 openAllApps() {
        ...
        if (FeatureFlags.NO_ALL_APPS_ICON) {
            ...
            findViewById(com.rgks.launcher3.R.id.page_indicator).click();
        } else {
            mDevice.wait(Until.findObject(
                    By.desc(mTargetContext.getString(com.rgks.launcher3.R.string.all_apps_button_label))),
                    DEFAULT_UI_TIMEOUT).click();
        }
        return findViewById(com.rgks.launcher3.R.id.apps_list_view);
    }
    ...
    protected UiObject2 openWidgetsTray() {
        ...
        mDevice.wait(Until.findObject(
                By.text(mTargetContext.getString(com.rgks.launcher3.R.string.widget_button_text)
                        .toUpperCase(Locale.getDefault()))), DEFAULT_UI_TIMEOUT).click();
        return findViewById(com.rgks.launcher3.R.id.widgets_list_view);
    }
    ...
    protected void dragToWorkspace(UiObject2 icon, boolean expectedToShowShortcuts) {
        ...
        UiObject2 dragLayer = findViewById(com.rgks.launcher3.R.id.drag_layer);

        if (expectedToShowShortcuts) {
            // Make sure shortcuts show up, and then move a bit to hide them.
            assertNotNull(findViewById(com.rgks.launcher3.R.id.deep_shortcuts_container));

            Point moveLocation = new Point(center);
            int distanceToMove = mTargetContext.getResources().getDimensionPixelSize(
                    com.rgks.launcher3.R.dimen.deep_shortcuts_start_drag_threshold) + 50;
            ...
            assertNull(findViewById(com.rgks.launcher3.R.id.deep_shortcuts_container));
        }

        // Wait until Remove/Delete target is visible
        assertNotNull(findViewById(com.rgks.launcher3.R.id.delete_target_text));
        ...
        mDevice.wait(Until.gone(getSelectorForId(com.rgks.launcher3.R.id.delete_target_text)), DEFAULT_UI_TIMEOUT);
    }

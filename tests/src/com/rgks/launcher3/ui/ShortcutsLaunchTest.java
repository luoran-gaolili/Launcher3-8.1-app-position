...
public class ShortcutsLaunchTest extends AbstractLauncherUiTest {
    ...
    private void performTest() throws Exception {
        ...
        UiObject2 deepShortcutsContainer = findViewById(com.rgks.launcher3.R.id.deep_shortcuts_container);
        ...
        UiObject2 shortcut = deepShortcutsContainer.getChildren().get(0)
                .findObject(getSelectorForId(com.rgks.launcher3.R.id.bubble_text));
        shortcut.click();

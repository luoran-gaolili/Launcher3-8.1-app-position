...
public class Folder extends AbstractFloatingView implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mExpandDuration = res.getInteger(com.rgks.launcher3.R.integer.config_folderExpandDuration);
        mMaterialExpandDuration = res.getInteger(com.rgks.launcher3.R.integer.config_materialFolderExpandDuration);
        mMaterialExpandStagger = res.getInteger(com.rgks.launcher3.R.integer.config_materialFolderExpandStagger);

        if (sDefaultFolderName == null) {
            sDefaultFolderName = res.getString(com.rgks.launcher3.R.string.folder_name);
        }
        if (sHintText == null) {
            sHintText = res.getString(com.rgks.launcher3.R.string.folder_hint_text);
        }
    ...
    protected void onFinishInflate() {
        ...
        mContent = (FolderPagedView) findViewById(com.rgks.launcher3.R.id.folder_content);
        mContent.setFolder(this);

        mPageIndicator = (PageIndicatorDots) findViewById(com.rgks.launcher3.R.id.folder_page_indicator);
        mFolderName = (ExtendedEditText) findViewById(com.rgks.launcher3.R.id.folder_name);
        ...
        mFooter = findViewById(com.rgks.launcher3.R.id.folder_footer);
    ...
    public boolean onBackKey() {
        ...
        Utilities.sendCustomAccessibilityEvent(
                ...
                getContext().getString(com.rgks.launcher3.R.string.folder_renamed, newTitle));
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater().inflate(
                FeatureFlags.LAUNCHER3_DISABLE_ICON_NORMALIZATION
                        ? com.rgks.launcher3.R.layout.user_folder : com.rgks.launcher3.R.layout.user_folder_icon_normalized, null);
    }
        ...
        a.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                Utilities.sendCustomAccessibilityEvent(
                        Folder.this,
                        AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED,
                        getContext().getString(com.rgks.launcher3.R.string.folder_closed));
            }
        });
        startAnimation(a);
    }
    ...
    @Thunk void onDragOver(DragObject d, int reorderDelay) {
        ...
        if (mTargetRank != mPrevTargetRank) {
            ...
            if (d.stateAnnouncer != null) {
                d.stateAnnouncer.announce(getContext().getString(com.rgks.launcher3.R.string.move_to_position,
                        mTargetRank + 1));
            }
        }
    ...
    private void centerAboutIcon() {
        ...
        DragLayer.LayoutParams lp = (DragLayer.LayoutParams) getLayoutParams();
        DragLayer parent = (DragLayer) mLauncher.findViewById(com.rgks.launcher3.R.id.drag_layer);
        int width = getFolderWidth();
        int height = getFolderHeight();
    ...
    public void onDrop(DragObject d) {
        ...
        if (d.stateAnnouncer != null) {
            d.stateAnnouncer.completeAction(com.rgks.launcher3.R.string.item_moved);
        }
    }

...
public class AllAppsTransitionController implements TouchController, SwipeDetector.Listener,
    ...
    public AllAppsTransitionController(Launcher l) {
        ...
        mIsDarkTheme = Themes.getAttrBoolean(mLauncher, com.rgks.launcher3.R.attr.isMainColorDark);
    }
    ...
    public void onDragEnd(float velocity, boolean fling) {
        ...
        final int containerType = mTouchEventStartedOnHotseat
                ? LauncherLogProto.ContainerType.HOTSEAT : LauncherLogProto.ContainerType.WORKSPACE;
    ...
    private void updateAllAppsBg(float progress) {
        ...
        if (mGradientView == null) {
            mGradientView = (GradientView) mLauncher.findViewById(com.rgks.launcher3.R.id.gradient_bg);
    ...
    public void showDiscoveryBounce() {
        ...
        mDiscoBounceAnimation = AnimatorInflater.loadAnimator(mLauncher,
                com.rgks.launcher3.R.animator.discovery_bounce);

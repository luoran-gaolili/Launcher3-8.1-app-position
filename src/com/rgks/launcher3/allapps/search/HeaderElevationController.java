...
public class HeaderElevationController extends RecyclerView.OnScrollListener {
    ...
    public HeaderElevationController(View header) {
        ...
        mMaxElevation = res.getDimension(com.rgks.launcher3.R.dimen.all_apps_header_max_elevation);
        mScrollToElevation = res.getDimension(com.rgks.launcher3.R.dimen.all_apps_header_scroll_to_elevation);

...
public class DragLayer extends InsettableFrameLayout {
    ...
    private void sendTapOutsideFolderAccessibilityEvent(boolean isEditingName) {
        int stringId = isEditingName ? com.rgks.launcher3.R.string.folder_tap_to_rename : com.rgks.launcher3.R.string.folder_tap_to_close;
    ...
    public void setInsets(Rect insets) {
        ...
        setBackground(insets.top == 0 ? null
                : Themes.getAttrDrawable(getContext(), com.rgks.launcher3.R.attr.workspaceStatusBarScrim));
    }
    ...
    public void addResizeFrame(LauncherAppWidgetHostView widget, CellLayout cellLayout) {
        ...
        mCurrentResizeFrame = (AppWidgetResizeFrame) LayoutInflater.from(mLauncher)
                .inflate(com.rgks.launcher3.R.layout.app_widget_resize_frame, this, false);
    ...
    public void animateView(final DragView view, final Rect from, final Rect to,
        ...
        final float maxDist = (float) res.getInteger(com.rgks.launcher3.R.integer.config_dropAnimMaxDist);

        // If duration < 0, this is a cue to compute the duration based on the distance
        if (duration < 0) {
            duration = res.getInteger(com.rgks.launcher3.R.integer.config_dropAnimMaxDuration);
            if (dist < maxDist) {
                duration *= mCubicEaseOutInterpolator.getInterpolation(dist / maxDist);
            }
            duration = Math.max(duration, res.getInteger(com.rgks.launcher3.R.integer.config_dropAnimMinDuration));
        }

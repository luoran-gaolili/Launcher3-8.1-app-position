...
import static com.rgks.launcher3.logging.LoggerUtils.newCommandAction;
import static com.rgks.launcher3.logging.LoggerUtils.newContainerTarget;
import static com.rgks.launcher3.logging.LoggerUtils.newItemTarget;
import static com.rgks.launcher3.logging.LoggerUtils.newLauncherEvent;
...
public class AddItemActivity extends BaseActivity implements OnLongClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.rgks.launcher3.R.layout.add_item_confirmation_activity);
        mWidgetCell = findViewById(com.rgks.launcher3.R.id.widget_cell);
    ...
    public boolean onLongClick(View view) {
        ...
        if (!getResources().getBoolean(com.rgks.launcher3.R.bool.allow_rotation) &&

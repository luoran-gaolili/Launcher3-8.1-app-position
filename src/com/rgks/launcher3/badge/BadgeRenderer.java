...
public class BadgeRenderer {
    ...
    public BadgeRenderer(Context context, int iconSizePx) {
        ...
        mLargeIconDrawer = new IconDrawer(res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.badge_small_padding));
        mSmallIconDrawer = new IconDrawer(res.getDimensionPixelSize(com.rgks.launcher3.R.dimen.badge_large_padding));

...
public class WidgetsContainerView extends BaseContainerView
    ...
    protected void onFinishInflate() {
        ...
        mRecyclerView = (WidgetsRecyclerView) getContentView().findViewById(com.rgks.launcher3.R.id.widgets_list_view);
    ...
    public void handleClick() {
        ...
        CharSequence msg = Utilities.wrapForTts(
                getContext().getText(com.rgks.launcher3.R.string.long_press_widget_to_add),
                getContext().getString(com.rgks.launcher3.R.string.long_accessible_way_to_add));
    ...
    private boolean beginDraggingWidget(WidgetCell v) {
        ...
        WidgetImageView image = (WidgetImageView) v.findViewById(com.rgks.launcher3.R.id.widget_preview);
    ...
    public void setWidgets(MultiHashMap<PackageItemInfo, WidgetItem> model) {
        ...
        View loader = getContentView().findViewById(com.rgks.launcher3.R.id.loader);
        if (loader != null) {

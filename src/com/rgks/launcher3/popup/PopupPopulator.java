...
public class PopupPopulator {
    ...
    public enum Item {
        SHORTCUT(com.rgks.launcher3.R.layout.deep_shortcut, true),
        NOTIFICATION(com.rgks.launcher3.R.layout.notification, false),
        SYSTEM_SHORTCUT(com.rgks.launcher3.R.layout.system_shortcut, true),
        SYSTEM_SHORTCUT_ICON(com.rgks.launcher3.R.layout.system_shortcut_icon_only, true);

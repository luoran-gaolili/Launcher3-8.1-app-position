...
public class QsbWidgetHostView extends AppWidgetHostView {
    ...
    public static View getDefaultView(ViewGroup parent) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(com.rgks.launcher3.R.layout.qsb_default_view, parent, false);
        v.findViewById(com.rgks.launcher3.R.id.btn_qsb_search).setOnClickListener(new OnClickListener() {
            @Override

...
public class IconShapeOverride {
        ...
        public boolean onPreferenceChange(Preference preference, Object o) {
            ...
            if (!getAppliedValue(mContext).equals(newValue)) {
                ...
                ProgressDialog.show(mContext,
                        null /* title */,
                        mContext.getString(com.rgks.launcher3.R.string.icon_shape_override_progress),
                        true /* indeterminate */,
                        false /* cancelable */);
    ...
    private static class OverrideApplyHandler implements Runnable {
        ...
        public void run() {
            ...
            Utilities.getDevicePrefs(mContext).edit().putString(KEY_PREFERENCE, mValue).commit();
